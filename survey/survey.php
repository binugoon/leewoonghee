  ...
  <form name=survey_form method=post > 
    <table border=0 cellspacing=0 cellpdding=0 width='300' align='center'>
      <input type=hidden name=kkk value=100>
       ...
       <tr><td><input type=radio name='singer' value='ans1' >1.동방신기</td></tr>
       <tr height=5><td></td></tr>
       <tr><td><input type=radio name='singer' value='ans2' >2.이효리</td></tr>
       <tr height=5><td></td></tr>
       <tr><td><input type=radio name='singer' value='ans3' >3.비</td></tr>
       <tr height=5><td></td></tr>
       <tr><td><input type=radio name='singer' value='ans4' >4.세븐</td></tr>
       <tr height=7><td></td></tr>
       <tr height=1 bgcolor=#5AB2C8><td></td></tr>
       <tr>
       <tr height=7><td></td></tr>
